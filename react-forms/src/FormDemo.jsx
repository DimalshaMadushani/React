...
//when the mode is set to onChange the form is validated on every change
//register is a function that is used to register the input fields with the react-hook-form
